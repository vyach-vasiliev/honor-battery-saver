...
На сайте показаны настоящие окна настроек и диагностики в тёмной теме на русском и английском языках. Имена сетей и диагностические статусы — демоданные, а не результаты аппаратной проверки. Для повторного создания четырёх PNG в Windows:
